...
configTable = {
	...
	-- nine ball
	{
		...
		ballsList = {
			...
			{ 923.8, 320, 52, 46, 227, "two" },
			{ 889.2, 340, 220, 7, 7, "three" },
			{ 854.6, 280, 156, 67, 179, "four" },
			{ 923.8, 280, 250, 146, 8, "five" },
			{ 889.2, 260, 36, 118, 5, "six" },
			{ 854.6, 320, 133, 65, 37, "seven" },
			{ 958.4, 300, 0, 0, 0, "eight" },
			{ 889.2, 300, 255, 252, 180, "nine" },
		},
